export default class Store {
    ...
    removeMenu(event) {
        let menuList = this.menuList.filter(menu => {return menu.code !== event.getAttribute("id")});
    ...
    onEditMenuName(code, name) {
        let menuIdx = this.menuList.findIndex(menuItem => {return menuItem.code === code});
    ...
    setMenuSoldOutState(menu) {
        let menuIdx = this.menuList.findIndex(menuItem => {return menuItem.code === menu.getAttribute("id")});
