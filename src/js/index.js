...
const drinkItemTemplate = (name) => `<li class="menu-list-item d-flex items-center py-2">
...
function addMenuItem() {
  ...
  //menuList.innerHTML += drinkItemTemplate($('#espresso-menu-name').value);
...
function start() {
  ...
  menuList.addEventListener('click', function (e) {
    if (e.target.classList.contains('menu-remove-button') && confirm('정말로 삭제하시겠습니까?')) {
