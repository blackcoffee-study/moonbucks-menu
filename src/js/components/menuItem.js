...
export default function getMenuItem(name) {
  ...
  deleteBtn.addEventListener('click', () => deleteItem(menuItem.getElement(), name))
  updateBtn.addEventListener('click', () => updateItem(menuName))
